...
const commercialAircraftPattern =
  /\b(?:airliners?|cargo aircraft|cargo plane|commercial aircraft|freighter aircraft|jetliner|narrow-body|passenger aircraft|passenger jet|regional aircraft|regional jet|regional turboprop|turboprop airliner|wide-body)\b/i;
