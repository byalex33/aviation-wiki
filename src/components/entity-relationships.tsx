...
import { getPublicDiscoverySections } from "@/lib/wiki-public-db";
...
export async function ApprovedRelationships({ article }: { article: ArticleRecord }) {
  const sections = await getPublicDiscoverySections(article.id);
