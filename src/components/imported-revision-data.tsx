...
import { getRevisionImportFieldSources, getRevisionImportImages } from "@/lib/wiki-db";

export function ImportedRevisionData({ revisionId }: { revisionId: string }) {
  const fields = getRevisionImportFieldSources(revisionId);
  const images = getRevisionImportImages(revisionId);
