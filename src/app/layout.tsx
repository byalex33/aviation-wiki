            ...
            <div className="mx-auto max-w-[1200px] px-5 sm:px-6">
              ...
              <div className="flex flex-col gap-3 border-t border-background/10 py-5 text-xs text-background/40 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    href="https://github.com/byalex33/aviation-wiki"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="aviation.wiki source code on GitHub"
                    className="-my-1.5 inline-flex size-8 items-center justify-center rounded-md transition-colors hover:bg-background/10 hover:text-background"
                  >
