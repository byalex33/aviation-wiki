...
export default async function AdminImportPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const results = query.length >= 2 && !rateLimited ? await provider.search(query, contentType) : [];
